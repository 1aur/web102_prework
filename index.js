...
function addGamesToPage(games) {
    ...
    for (let i = 0; i < games.length; i++) {
        ...
        // create a new element to hold the name of the game, then append it to the game cardx
...
const companyDescription = `A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games. Currently, ${unfundedGames.length} game${unfundedGames.length !== 1 ? "s" : ""} remain unfunded. We need your help to fund these amazing games!`;
